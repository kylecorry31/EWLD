...
Everyone gets nightmares every once in a while, but if you have a nightmare and become lucid it could be scary. Just remember that you are in control of you dream if this happens. Most nightmares actually represent an inner conflict, so if you do find yourself in a nightmare try to resolve the conflict peacefully. If you are being chased or attacked by someone or something, become friends with them and ask them politely why they are doing whatever they are doing to you. Many times they will give an answer, and you will wake up feeling really good. 

\section{Prescriptions for Nightmares}
Here are a few different common nightmare scenarios and how you can overcome them. 

\subsection{Being Pursued}
Stop running and face the pursuer. The pursuer may disappear or become harmless and if not try having a conversation with them to resolve the conflict. 

\subsection{Being Attacked}
Defend yourself and try to have a conversation with the attacker to resolve the conflict or embrace the attacker and show that you care for them.

\subsection{Falling}
Relax and allow yourself to land. 

\subsection{Paralysis}
Relax and tell yourself that you are dreaming and it will end soon. Let yourself go along with what you see around you and don't become anxious as nothing can actually hurt you. 

\subsection{Being Unprepared for an Exam or Speech}
You don't even need to continue with these kinds of dreams, so you can leave. Either that or creatively answer problems or give a creative speech. 

\subsection{Being Naked in Public}
Who cares if you are naked in a dream, just act like it's normal. 

\section{Recurrent Nightmares}
Sometimes the same nightmare happens over and over again. To stop this, try to resolve the nightmare as discussed previously. If that doesn't work, try to think of a creative solution during the day and when the nightmare happens, imagine yourself following that solution. For example, if you are trapped in a locked room with the walls closing in, reach into your pocket and grab the key to open the door and leave. 

\chapter{The Healing Dream}

\section{Wholeness and Health}
Health is defined as a condition of adaptive responsiveness to the challenges of life, therefore lucid dreaming can help to improve your health. One way to use lucid dreams to improve your mental health is to accept all of your inner conflicts, discussed in the previous chapter. You can also use lucid dreaming to seek opportunities for growth by looking for potential difficulties and facing them with confidence. Another way to become healthier is by finishing unfinished business, like saying goodbye to a loved one, or accepting their death and talking to them in lucid dreams. Finally, lucid dreaming can increase your mental flexibility and mindfulness, so you will be able to face more challenges and be more aware throughout your waking life. 

\chapter{Life is a Dream: Intimations of a Wider World}

\section{A Vehicle for Exploring Reality}
Once you have been lucid dreaming for a while you will realize the similarities and difference between the dream world and the waking world. The main take aways are:

\begin{enumerate}
	\item Dreams can be changed by will
	\item Dreams are unstable
	\item Waking-state perception is as unreal as unreal dreams
	\item It's all a dream - everything is just a perception that your mind is generating to which you can be aware of
\end{enumerate}

\section{Self-Knowledge}
It is hard to know who you truly are, you only know who you believe you are. The first step is to realize that you are not necessarily your dream ego. "The less we identify with who we think we are, the more likely we are to discover who we really are"\cite{leberge}. Sometimes to find your inner-self, you must stop looking and surrender your ego-control. Your true self will normally represent your belief of a higher power, such as God. 

\section{Humanity is Asleep}
Most people walk throughout their days in a state of semi-awareness. Many will never lucid dream or even venture outside of their comfort zones. Distractions are pulling people away from their true awareness, one which can be relearned through lucid dreaming. 
